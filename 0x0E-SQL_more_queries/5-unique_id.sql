...
-- name VARCHAR(256) The database name will be passed as an argument of the
-- mysql command If the table unique_id already exists, your script should not fail
